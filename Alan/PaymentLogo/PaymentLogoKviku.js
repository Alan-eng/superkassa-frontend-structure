...
const PaymentLogoKviku = (props) => {
    return (
        <div className={props.checked ? style.containerChecked : style.container} checked={props.checked} onClick={() => props.handleChecked('kviku')} >
            {kviku}
